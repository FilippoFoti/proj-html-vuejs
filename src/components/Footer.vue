            ...
            <div class="row">
                <div class="col">
                    ...
                    <form action="">
                        ...
                        <textarea rows="5" cols="1" placeholder="Message"></textarea>
                    </form>
                    <button>SEND</button>
                </div>
                <div class="col map">
                    <h4>Example Inc.</h4>
                    <p>Lorem ipsum dolor sit amer, consectetur adipiscingelit.</p>
            ...
            .col {
                ...
                form {
                    ...
                    input {
                        ...
                        outline: 0;
                        padding: 10px;
                        background-color: rgba(29, 29, 35, 1);
                        color: #e4eae6;
                        border-radius: 5px;
                        border: 0;
                    }
                ...
                button {
                    padding: 10px 20px;
                    border-radius: 5px;
                    border: 1px solid rgba(5, 130, 131, 1);
                    color: white;
                    font-weight: bold;
